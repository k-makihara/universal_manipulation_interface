                ...
                while True:
                    ...
                    for key_stroke in press_events:
                        if key_stroke == KeyCode(char='q'):
                            ...
                            pose = np.array([ 0.16294129, -0.45856071,  0.3055573 , -0.00648847,  2.93917308,      -0.9963089 ])
                            env.robots[0].servoL(pose, duration=duration)
                    ...
                    for robot_idx in range(target_pose.shape[0]):
                        ...
                        #print(gripper_target_pos[robot_idx])
